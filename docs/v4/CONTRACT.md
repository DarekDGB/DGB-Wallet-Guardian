...
This document defines the first Guardian Wallet Shield v4 component-verdict contract.
...
The V4.5A Guardian Wallet pilot uses deterministic TEST-ONLY signatures for contract and CI locking.
