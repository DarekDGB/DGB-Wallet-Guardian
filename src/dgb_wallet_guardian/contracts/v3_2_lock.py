...
COMPONENT_NAME = 'DGB Wallet Guardian'
SUPPORTED_REASON_IDS = ('GW_OK_HEALTHY_ALLOW', 'GW_ESCALATE_QID_REQUIRED', 'GW_DENY_POLICY_BLOCKED', 'GW_ERROR_INVALID_VERDICT', 'GW_ERROR_CONTEXT_HASH_MISMATCH')
SUPPORTED_EVIDENCE_FAMILIES = ('wallet_context', 'transaction_context', 'qid_auth_context', 'sentinel_signal', 'device_signal')
