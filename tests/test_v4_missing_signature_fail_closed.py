...
from dgb_wallet_guardian.v4 import CANONICALIZATION_PROFILE, CONTRACT_VERSION, POLICY_VERSION, VERDICT_SCHEMA_VERSION
from dgb_wallet_guardian.v4.crypto_verdict import validate_crypto_verdict_envelope
from dgb_wallet_guardian.v4.signing import build_signature_bundle, build_test_signature_entry, signed_payload_hash, verify_test_only_signature
from dgb_wallet_guardian.v4.trust_profile import CLASSICAL_ED25519, KEY_REGISTRY_SCHEMA_VERSION, ML_DSA, build_test_trust_profile, validate_trust_profile

from tests.test_v4_crypto_verdict_contract import HASH_A, VERIFY_AT, signed_verdict, unsigned_payload


def test_guardian_wallet_v4_missing_required_ml_dsa_signature_fails_closed() -> None:
...
def test_guardian_wallet_v4_verdict_envelope_mutations_fail_closed(mutator, match: str) -> None:
...
def test_guardian_wallet_v4_signature_bundle_shape_fail_closed() -> None:
    verdict = signed_verdict()
    bad_bundles = [
        "not-dict",
...
def test_guardian_wallet_v4_rejects_non_dict_verdict() -> None:
...
def test_guardian_wallet_v4_trust_profile_shape_fail_closed() -> None:
...
def test_guardian_wallet_v4_constant_imports_are_stable() -> None:
...
def test_guardian_wallet_v4_test_signature_builder_hash_guards() -> None:
    from dgb_wallet_guardian.v4.signing import build_test_signature_entry
