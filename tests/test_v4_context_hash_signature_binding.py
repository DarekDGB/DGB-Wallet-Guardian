...
from dgb_wallet_guardian.contracts.v3_2_lock import SUPPORTED_EVIDENCE_FAMILIES, SUPPORTED_REASON_IDS
from dgb_wallet_guardian.v4.crypto_verdict import build_signed_crypto_verdict_envelope, build_unsigned_crypto_verdict_payload, validate_crypto_verdict_envelope
from dgb_wallet_guardian.v4.signing import parse_json_no_duplicate_keys, verify_test_only_signature, to_canonical_json
from dgb_wallet_guardian.v4.trust_profile import build_test_trust_profile
...
def test_guardian_wallet_v4_expected_context_hash_is_bound() -> None:
...
def test_guardian_wallet_v4_changed_context_after_signing_changes_payload_hash() -> None:
...
def test_guardian_wallet_v4_canonicalization_rejects_ambiguous_payloads() -> None:
...
def test_guardian_wallet_v4_unsigned_payload_builder_fail_closed_guards() -> None:
    base = {
        "request_id": "req-guardian-wallet-v4",
        "context_hash": HASH_A,
        "freshness_nonce": "nonce-guardian-wallet-v4",
    ...
    with pytest.raises(ValueError, match="unsigned Guardian Wallet v4 verdict"):
