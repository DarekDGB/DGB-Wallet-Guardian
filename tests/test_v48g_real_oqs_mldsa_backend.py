...
from dgb_wallet_guardian.v4.oqs_mldsa_backend import OQS_ML_DSA_MECHANISM, OqsMlDsaBackend  # noqa: E402
...
MESSAGE = b"DGB Shield v4.8G real liboqs ML-DSA proof: guardian-wallet"
PRIVATE_KEY_REFERENCE = "hsm://guardian-wallet/real-oqs-ml-dsa/v1"
...
def test_v48g_real_oqs_mldsa65_guardian_backend_round_trip_and_negatives() -> None:
