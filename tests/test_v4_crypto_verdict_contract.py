...
from dgb_wallet_guardian.v4 import COMPONENT_ID, COMPONENT_ROLE, CONTRACT_VERSION, VERDICT_SCHEMA_VERSION
from dgb_wallet_guardian.v4.crypto_verdict import (
...
from dgb_wallet_guardian.v4.trust_profile import CLASSICAL_ED25519, FN_DSA, ML_DSA, build_test_trust_profile
...
def unsigned_payload() -> dict:
    return build_unsigned_crypto_verdict_payload(
        ...
        metadata={"pilot": "guardian-wallet-v4", "nested": {"safe": True}},
...
def test_guardian_wallet_v4_signed_component_verdict_contract_validates() -> None:
    payload = unsigned_payload()
