...
def test_v49i2_guardian_wallet_bundle_builder_emits_canonical_order_without_mutating_input(
...
def test_v49i2_guardian_wallet_bundle_builder_preserves_empty_internal_shell_construction() -> None:
    bundle = build_signature_bundle(signatures=[])

    assert bundle["signatures"] == []


def test_v49i2_guardian_wallet_bundle_builder_rejects_non_object_entry() -> None:
...
def test_v49i2_guardian_wallet_verifier_rejects_noncanonical_order_before_key_lookup_or_crypto(
    ...
    monkeypatch.setattr(
        "dgb_wallet_guardian.v4.signing.find_trusted_key",
